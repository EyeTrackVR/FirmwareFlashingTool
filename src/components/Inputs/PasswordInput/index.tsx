...
const PasswordInput: Component<IProps> = (props) => {
    ...
    return (
        <div
            ...
            class="flex justify-center items-center p-6 h-[39px] bg-black-800 w-full rounded-6 placeholder-grey-100 text-white-100">
            <input
                required={props.required}
                autofocus={props.autoFocus}
                onFocus={() => setActive(true)}
                onBlur={() => setActive(false)}
                class="h-full pl-6 pr-6 bg-black-800 w-full rounded-6 border-solid border-0 focus:ring-0 focus:ring-black-800 border-black-800 placeholder-grey-100 text-[12px] text-white-100 focus:border-0 focus:border-black-800"
                onInput={(e) => {
