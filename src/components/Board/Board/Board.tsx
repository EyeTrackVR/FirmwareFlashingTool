...
export const Board: Component<IProps> = (props) => {
    const styles = createMemo(() => {
        return props.isActive
            ? 'hover:bg-[#9793FD] rounded-[6px] pt-[6px] pb-[6px] pr-[12px] pl-[12px] text-left border border-solid border-[#817DF7] hover:border-[#9793FD] cursor-pointer bg-[#817DF7]'
            : 'hover:bg-[#192736] rounded-[6px] pt-[6px] pb-[6px] pr-[12px] pl-[12px] text-left  border border-solid border-[#0D1B26] cursor-pointer'
    })
