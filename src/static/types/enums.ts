...
export enum FLASH_WIZARD_STEPS {
    ...
    BEFORE_CONTINUE_CONFIG = 'BEFORE_CONTINUE_CONFIG',
    SELECT_MODE = 'SELECT_MODE',
    FLASH_PROCESS_FAILED = 'FLASH_PROCESS_FAILED',
    SETUP_TRACKER_NAME = 'SETUP_TRACKER_NAME',
    FLASH_WIRED_PROCESS = 'FLASH_WIRED_PROCESS',
    FLASH_WIRED_PROCESS_FAILED = 'FLASH_WIRED_PROCESS_FAILED',
    FLASH_WIRED_PROCESS_SUCCESS = 'FLASH_WIRED_PROCESS_SUCCESS',
    SHOW_TERMINAL = 'SHOW_TERMINAL',
    SETUP_CREDENTIALS = 'SETUP_CREDENTIALS',
    SCAN_NETWORK = 'SCAN_NETWORK',
    SETUP_MDNS = 'SETUP_MDNS',
    WIFI_CONNECTING = 'WIFI_CONNECTING',
    WIFI_CONNECTING_SUCCESS = 'WIFI_CONNECTING_SUCCESS',
    WIFI_CONNECTING_FAILED = 'WIFI_CONNECTING_FAILED',
}
